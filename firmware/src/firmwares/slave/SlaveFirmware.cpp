...
#include "i2c/commands/FlashDeviceIdentificationLightsCommandHandler.h"
...
void SlaveFirmware::setup() {
    ...
    if (deviceAddress > 0) {
        ...
        slavePort.addCommandHandler(new i2c::commands::FlashDeviceIdentificationLightsCommandHandler(*device));
    }
}
