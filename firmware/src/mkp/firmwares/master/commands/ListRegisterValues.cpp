...
ListRegisterValues::ListRegisterValues(const std::optional<tfw::utils::registers::RegisterManager*>& registers)
    : CommandHandler("list.register.values"),
      registers(registers) {}

ListRegisterValues::~ListRegisterValues() = default;


tfw::utils::void_result ListRegisterValues::execute(
